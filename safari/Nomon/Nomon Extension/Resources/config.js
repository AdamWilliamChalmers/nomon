// Single source of truth for where the extension talks to the Nomon backend.
//
// Production default ships in the published extension. For local development,
// open the Nomon pill → settings and set the "Backend URL" field to
...
const LumenConfig = (() => {
  const DEFAULT_WEB_APP_URL = "https://nomon-app.com";
